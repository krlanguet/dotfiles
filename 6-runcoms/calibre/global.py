...
database_path = '/home/keith/library1.db'
...
library_path = u'/home/keith/Shared Data/Drive/[Collection] - Categorized Sources/Calibre Library'
...
# installation uuid
# Installation UUID
installation_uuid = 'dc014d9c-fde6-4741-8d82-78cfd439aead'
...
limit_search_columns_to = cPickle.loads('\x80\x02]q\x01(X\x05\x00\x00\x00titleq\x02X\x07\x00\x00\x00authorsq\x03X\x04\x00\x00\x00tagsq\x04X\x06\x00\x00\x00seriesq\x05e.')
